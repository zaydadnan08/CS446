...
class CommunityFridgeViewModel @Inject constructor(
    private val requestUseCases: RequestUseCases, private val repository: AuthRepository
) : ViewModel() {
    ...
    fun addRequest(name:String, description:String, amount:String, location:String, fridgeName:String) =
        viewModelScope.launch {
