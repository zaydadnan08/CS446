...
interface MarketRepository {
    ...
    suspend fun addItemToFirestore(product_name: String, seller: String, price: String, description: String, location: String, contact_number: String): AddItemResponse
